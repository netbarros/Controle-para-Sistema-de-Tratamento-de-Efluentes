                ...
                if (status == 'Valid') {
                    ...
                    $.ajax({
                     ...
                     submitButton.removeAttribute('data-kt-indicator');
                      ...
                      $("#kt_login_signin_submit").html('<span class="spinner-border spinner-border-sm" role="status" aria-hidden="true"></span> Autenticando...');
                            ...
                            if (response.codigo == "1") {
                               ...
                               // $("#kt_login_signin_submit").html('Autenticando');
                                ...
                                if (response.nivel != "operador") {
                                    ...
                                    $("#kt_login_signin_submit").html('Entrar');
